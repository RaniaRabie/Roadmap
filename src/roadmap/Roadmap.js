...
const Roadmap = () => {
  ...
  const progress = roadmap?.dataToPublish?.nodes?.length
    ? (completedNodes.length / roadmap.dataToPublish.nodes.length) * 100
    : 0;
  ...
  return roadmap ? (
    <div style={{ width: "100%", height: "95vh" }}>
      ...
      <p style={{ textAlign: "center" }}>
        {roadmap.dataToPublish.roadmapDescription}
      </p>
      <br />

      <ReactFlowProvider>
        <ReactFlow
          nodes={roadmap.dataToPublish.nodes.map((node) => ({
            ...node,
            data: {
              ...node.data,
              label: (
          ...
          edges={roadmap.dataToPublish.edges}
          fitView
